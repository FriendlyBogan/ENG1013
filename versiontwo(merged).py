...
def display_main_menu(username, userParameters, polledData, board):
    """
    ...
    if choice == 1:
        ...
        userParameters = authorize_user(username, userParameters, polledData)
    elif choice == 3:
...
def display_data_observation_menu(username, userParameters, polledData):
    """
...
def main():
    ...
    while True:
        username, userParamters = display_main_menu(username, userParamters)
